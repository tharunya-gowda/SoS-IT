...
class PetAdapter(private val userList: ArrayList<Med>): RecyclerView.Adapter<PetAdapter.MyMedViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyMedViewHolder {
        ...
        additem.setOnClickListener(View.OnClickListener {
            ...
            itemcount.text=itemcountval.toString()
            val item: CartItem = CartItem(name.text.toString(),trimmed,itemcountval.toString())
            cartlist.add(item)
        })
